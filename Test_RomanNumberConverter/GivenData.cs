    ...
    public static class GivenData
    {
        public static IEnumerable BadRomanNumberCase
        {
            get
            {
                ...
                yield return new TestCaseData("XLX", "The combinaison XL can not be followed by L for roman number.", "because XLX is not an allowed combinaison for roman number");
            }
        }
